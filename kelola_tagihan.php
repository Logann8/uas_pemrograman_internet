...
include 'koneksi.php';
// Query tagihan
$q = mysqli_query($conn, "SELECT t.id, p.nama AS penghuni, k.nomor AS kamar, t.bulan, t.jml_tagihan FROM tb_tagihan t JOIN tb_kmr_penghuni kp ON t.id_kmr_penghuni=kp.id JOIN tb_penghuni p ON kp.id_penghuni=p.id JOIN tb_kamar k ON kp.id_kamar=k.id ORDER BY t.bulan DESC, p.nama");
...
<body>
    <div class="container">
        ...
        <a href="tambah_tagihan.php" class="button">+ Tambah Tagihan</a>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_tagihan.php?id=<?= $row['id'] ?>" class="button" style="background:#ffc107; color:#222;">Edit</a>
                        <a href="hapus_tagihan.php?id=<?= $row['id'] ?>" class="button" style="background:#dc3545;" onclick="return confirm('Yakin ingin menghapus tagihan ini?');">Hapus</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
